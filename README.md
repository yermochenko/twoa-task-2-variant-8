# Приложение для расчёта геометрической задачи для варианта №8

Приложение должно позволять по введённым координатам трёх вершин параллелограмма $(x_1, y_1)$, $(x_2, y_2)$ и
$(x_3, y_3)$ вычислять координаты оставшейся вершины. Приложение должно выводить все возможные варианты.
...
* координаты всех четырёх вершин параллелограмма для первого варианта расположения;
* координаты всех четырёх вершин параллелограмма для второго варианта расположения;
* координаты всех четырёх вершин параллелограмма для третьего варианта расположения.
